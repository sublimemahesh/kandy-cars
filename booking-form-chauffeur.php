...
<html lang="en">
    ...
    <link href="<?php echo actual_link(); ?>css/jquery.datetimepicker.css" rel="stylesheet" type="text/css"/>
...
<!--                                    <input type="text" name="txtMobileNumber" id="txtMobileNumber" class="form-control  " data-select="date"  placeholder="Mobile Number">--> 
    ...
    <script src="<?php echo actual_link(); ?>js/jquery.datetimepicker.full.js" type="text/javascript"></script>
