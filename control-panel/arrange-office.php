            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Office</h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="manage-office.php">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/office.php" class="form-horizontal" >
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    <?php
                                                    if (count($OFFICE->all()) > 0) {
                                                        foreach ($OFFICE->all() as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <h3><?php echo $img['location'] ?></h3>
