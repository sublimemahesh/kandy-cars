            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange SubService</h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="manage-sub-sub_service.php">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/sub-service.php" class="form-horizontal" >
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    <?php
                                                    if (count($SUB_SERVICE->all()) > 0) {
                                                        foreach ($SUB_SERVICE->all() as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/sub_services/<?php echo $img["image_name"]; ?>" alt=""/>
