...
<!--                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
    ...
    <!--                                    <small>  </small>-->
                            ...
                            <div class="body">
                                <div class="list-group">
                                    <a href="create-product-type.php"><button type="button" class="list-group-item">Add new</button></a>
                                    <a href="manage-product-type.php"><button type="button" class="list-group-item">Manage</button></a>
                                    <a href="arrange-products.php"><button type="button" class="list-group-item">Arrange</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!--                                    <small></small>-->
                            ...
                            <div class="body">
                                <div class="list-group">
                                    <a href="create-pages.php"><button type="button" class="list-group-item">Add new</button></a>
                                    <a href="manage-pages.php"><button type="button" class="list-group-item">Manage</button></a>
                                    <a href="edit-pages.php"><button type="button" class="list-group-item">Arrange</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="list-group">
                                    <a href="#"><button type="button" class="list-group-item">Add new</button></a>
