...
class Activities {
    ...
    public function __construct($id) {
        if ($id) {
            ...
            $query = "SELECT `id`,`title`,`keyword`,`image_name`,`short_description`,`description`,`queue` FROM `activities` WHERE `id`=" . $id;
    ...
    public function create() {
        ...
        $query = "INSERT INTO `activities` (`title`,`keyword`,`image_name`,`short_description`,`description`,`queue`) VALUES  ('"
                . $this->title . "','"
                . $this->keyword . "','"
                . $this->image_name . "', '"
    ...
    public function chechExistByName($title) {
    ...
    public function getByName($title) {
        ...
        $query = "SELECT `id`,`title`,`keyword`,`image_name`,`short_description`,`description`,`queue` FROM `activities` WHERE `title`='" . $title . "'";
