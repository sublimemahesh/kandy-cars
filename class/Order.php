                        ...
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td width="90%" valign="middle">
                                        <font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:14px;text-align: justify " >
                                            Thank you for making a reservation with us, your vehicle will be reserved for you and hope you have gone through our <a href="https://www.KandyCars.lk/term-and-condition-package.php?id=' . $VEHICKE_TYPE->id . '" target="_blank" >Terms and Conditions</a>.
                                            Your reservation details are as stated below, go through them again and, if you have made any mistakes, contact us by Mobile Phone ( direct calls/whatsapp/viber - (+94) 70 451 1450  Only , (because email contact might take time ) within 30 minutes of reservation to make modifications to your reservation. 
                                ...
                                <tr>
                                    ...
                                    <td width="90%" valign="middle">
                                        <font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:14px; " >
                                            The details of your reservation are stated below.
                                        </font>
                                    </td>
                                    <td width="5%">&nbsp;</td>
                                </tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="color:#6d6e70;font-family:Arial,Helvetica,sans-serif;font-size:16px;font-style:normal;font-weight:500;line-height:28px;padding:15px 40px 0px 40px; text-align: justify" align="left">
                                                            (in case if you will cancel the reservation fully, a cancellation fee of 25% of total charge will be charged at this moment (withing 30 minites of booking), and no charge will be applied for modifications or shifting  dates, but this will affect on the availability of the vehicle you have chosen, but in case if the duration is changed, either dates are deduced or added, we will charge accordingly, 20% of daily rental for deduced dates and , 100% of daily rental for added dates, in such case your daily rental will be calculated by dividing the Rental for the period by the number of the dates of the package)
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                                ...
                                                                KANDY CARS<br>
                                                                    <a href="https://www.KandyCars.lk" target="_blank">Kandy Cars Online Private Limited</a><br>
                                                                        <a href="https://www.Import.KandyCars.lk" target="_blank">Import Kandy Cars Online Private Limited</a><br>
                                                                            ...
                                                                            <p>
                                                                                Mobile - (+94) 70 451 1450
                                                                            </p>
                                                                            <p>
                                                                                Email - keer20180511@gmail.com
                                                                            </p>
                                                                            <p>
                                                                                Email - booking@kandycars.lk
                                                                            </p>
                                                                            <p>
                                                                                This is a system genrated Email, thus do not reply this, any replies will go unresponded.
                                                                                Use above contact details to contact instead.
                                                                            </p> 
                                                                            <p>
                                                                            <a href="https://www.KandyCars.lk/term-and-condition-package.php?id=' . $VEHICKE_TYPE->id . '" target="_blank" >Terms and Conditions</a>
                                                                                </p>
                                                                            </font>
                        ...
                        <td align="center" valign="middle">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td width="96%" align="center" style="border-bottom:1px solid #000000" height="50">
                                        <font style="font-family: Verdana, Geneva, sans-serif; color:#1400FF; font-size:18px;text-align:center; " >
                                            <h4> KANDY CARS Sri Lanka -  ' . $PRODUCT_TYPE->name . ' </h4>
                                        </font>
                                    </td>
                                    <td width="2%">&nbsp;</td>
                                </tr>
                                                        ...
                                                        <td style="color:#6d6e70;font-family:Arial,Helvetica,sans-serif;font-size:18px;font-style:normal;font-weight:bold;line-height:28px;padding:30px 40px 0px 40px" align="left">
                                                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                <tbody>
                                                                            ...
                                                                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="font-family:Open Sans,Helvetica,Arial,sans-serif;color:#333333;font-weight:600;text-align:center;font-size:22px;line-height:24px;padding-bottom:15px;padding-top:0;margin:0;border-bottom:1px solid #dddddd;tezt-align:center;" align="center">Booking Details.</td>
                                                                    ...
                                                                    <tr>
                                                                        <td style="color:#6d6e70;font-family:Arial,Helvetica,sans-serif;font-size:16px;font-style:normal;font-weight:500;line-height:28px;padding:15px 40px 0px 40px; text-align: justify" align="left">
                                                                            (in case if you will cancel the reservation fully, a cancellation fee of 25% of total charge will be charged at this moment, and no charge will be applied for modifications on shifting  dates, but this will affect on the availability of the vehicle you have chosen, but in case if the duration is changed, either dates are deduced or added, we will charge accordingly, 20% of daily rental for deduced dates and , 100% of daily rental for added dates, in such cases your daily rental will be calculated by dividing the Rental for the period by the number of the dates of the package)
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                                                ...
                                                                                KANDY CARS<br>
                                                                                    <a href="https://www.KandyCars.lk" target="_blank">Kandy Cars Online Private Limited</a><br>
                                                                                        <a href="https://www.Import.KandyCars.lk" target="_blank">Import Kandy Cars Online Private Limited</a><br>
                                                                                            ...
                                                                                            <p>
                                                                                                This is a System generated, thus do not reply this, any replies will go unresponded.
                                                                                                Use above contact details to contact instead.
                                                                                            </p> 
                                                                                            <p><a href="https://www.KandyCars.lk/term-and-condition-package.php?id=' . $VEHICKE_TYPE->id . '" target="_blank" >Terms and Conditions</a></p>
                                                                                            </font>
