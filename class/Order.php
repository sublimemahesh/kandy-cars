                                ...
                                <tr>
                                    ...
                                    <td width="90%" valign="middle">
                                        <font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:14px; ">
                                            <b style="color:#333333;">Client Number/Reference Number - ' . $this->id . '<br />
                                ...
                                <tr>
                                    ...
                                    <td width="90%" valign="middle">
                                        <font style="font-family: Verdana, Geneva, sans-serif; color:#68696a; font-size:14px;text-align: justify " >
                                            ...
                                            Your reservation details are as shown below, go through them again and, if you have made any mistakes, contact us by Mobile Phone ( direct calls/whatsapp/viber - (+94) 71 351 1350 ) Only , (because email contact might take time ) within 30 minutes of reservation to make modifications to your reservation. Booking can not be modified or cancelled thereafter, any payment made will not be refunded  in such cases.
